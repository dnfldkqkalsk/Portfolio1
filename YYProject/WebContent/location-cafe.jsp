...
<link rel="stylesheet" href="css/location-cafe-style.css">
				...
				<div class="container2">
					...
					<c:forEach items="${list }" var="vo" begin="0" end="4">
						...
						<!-- 게시물에 중복안되는 유일한 요소인 bNum를 줘서 클릭했을 때 같은 번호를 찾아서 열도록 함 -->
							<div class="list-view">
						<input type="hidden" id="listNum" value="${vo.getbNum() }">  
								<div class="list-img">
									...
									<div class="list-intro-top">
										...
										<div class="top-manage">
											<div class="board-modify">
												<a href="/YYProject/foodWrite?bNum=${vo.getbNum() }&actionName=boardUpdateForm"><p>수정</p></a>
											</div>

											<div class="board-delete">
												<a href="/YYProject/foodWrite?bNum=${vo.getbNum() }&actionName=boardDelete&l=${title}"><p>삭제</p></a>
											</div>
										</div>
										<%
											} else {
