...
<link rel="stylesheet" href="css/member-style2.css">
	...
	<div id="wrap">
		<div id="container">
			...
			<div class="contents">
				...
				<div class="container">
					<div class="seoul">
						<a href="/YYProject/user?actionName=list&c=서울">
							<div class="box-title">
								<h1>서울</h1>
							</div> <img src="img/cafe-seoul.jpg">
							<div class="cover"></div>
					...
					<!--seoul-->
					<div class="incheon">
						<a href="/YYProject/user?actionName=list&c=인천">
							<div class="box-title">
								<h1>인천</h1>
							</div> <img src="img/cafe-incheon.jpg">
							<div class="cover"></div>
							<div class="cover-title">
								<h1>인천</h1>
							</div>
					...
					<!--incheon-->
					<div class="busan">
						<a href="/YYProject/user?actionName=list&c=부산">
							<div class="box-title">
								<h1>부산</h1>
							</div> <img src="img/cafe-busan.jpg">
							<div class="cover"></div>
							<div class="cover-title">
								<h1>부산</h1>
							</div>
					...
					<!--busan-->
					<div class="jeju">
						<a href="/YYProject/user?actionName=list&c=제주도">
							<div class="box-title">
								<h1>제주도</h1>
							</div> <img src="img/cafe-jeju.jpg">
							<div class="cover"></div>
							<div class="cover-title">
								<h1>제주도</h1>
							</div>
					...
					<!--jeju-->
					<div class="gyeonggi">
						<a href="/YYProject/user?actionName=list&c=경기도">
							<div class="box-title">
								<h1>경기도</h1>
							</div> <img src="img/cafe-gyeonggi.jpg">
							<div class="cover"></div>
							<div class="cover-title">
								<h1>경기도</h1>
							</div>
					...
					<div class="gyeongsang">
						<a href="/YYProject/user?actionName=list&c=경상도">
							<div class="box-title">
								<h1>경상도</h1>
							</div> <img src="img/cafe-gyeongsang.jpg">
							<div class="cover"></div>
							<div class="cover-title">
								<h1>경상도</h1>
							</div>
					...
					<!--gyeongsang-->
					<div class="jeonla">
						<a href="/YYProject/user?actionName=list&c=전라도">
							<div class="box-title">
								<h1>전라도</h1>
							</div> <img src="img/cafe-jeonla.jpg">
							<div class="cover"></div>
							<div class="cover-title">
								<h1>전라도</h1>
							</div>
					...
					<!--jeonla-->
					<div class="gangwon">
						<a href="/YYProject/user?actionName=list&c=강원도">
							<div class="box-title">
								<h1>강원도</h1>
							</div> <img src="img/cafe-gangwon.jpg">
							<div class="cover"></div>
							<div class="cover-title">
								<h1>강원도</h1>
							</div>
